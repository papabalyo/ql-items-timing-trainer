...
while (G__6442__i < G__6442__a.length) {G__6442__a[G__6442__i] = arguments[G__6442__i + 0]; ++G__6442__i;}
  args = new cljs.core.IndexedSeq(G__6442__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__6443){
...
return cljs.core.get_in.call(null,new_db,p1__6444_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__6445_SHARP_){
return cljs.core.get_in.call(null,db,p1__6445_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
while (G__6446__i < G__6446__a.length) {G__6446__a[G__6446__i] = arguments[G__6446__i + 2]; ++G__6446__i;}
  in_paths = new cljs.core.IndexedSeq(G__6446__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__6447){
var f = cljs.core.first(arglist__6447);
arglist__6447 = cljs.core.next(arglist__6447);
var out_path = cljs.core.first(arglist__6447);
var in_paths = cljs.core.rest(arglist__6447);
...
//# sourceMappingURL=middleware.js.map?rel=1451300710462